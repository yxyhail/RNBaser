...
/**
 * Delegate class for {@link ReactActivity} and {@link com.facebook.react.ReactFragmentActivity}. You can subclass this
...
public class CustomReactActivityDelegate extends ReactActivityDelegate {
    ...
    private CustomReactDelegate mCustomReactDelegate;
    ...
    public ReactInstanceManager getReactInstanceManager() {
        return mCustomReactDelegate.getReactInstanceManager();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomReactDelegate =
                new CustomReactDelegate(
                        getPlainActivity(), getReactNativeHost(), mainComponentName, getLaunchOptions()) {
                    @Override
                    protected ReactRootView createRootView() {
                        return CustomReactActivityDelegate.this.createRootView();
                    }
                };
    ...
    protected void loadApp(String appKey) {
        mCustomReactDelegate.loadApp(appKey);
//        getPlainActivity().setContentView(mReactDelegate.getReactRootView());
    }

    protected void onPause() {
        mCustomReactDelegate.onHostPause();
    }

    protected void onResume() {
        mCustomReactDelegate.onHostResume();
    ...
    protected void onDestroy() {
        mCustomReactDelegate.onHostDestroy();
    }

    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        mCustomReactDelegate.onActivityResult(requestCode, resultCode, data, true);
    }
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        return mCustomReactDelegate.shouldShowDevMenuOrReload(keyCode, event);
    }
    ...
    public boolean onBackPressed() {
        return mCustomReactDelegate.onBackPressed();
    }
